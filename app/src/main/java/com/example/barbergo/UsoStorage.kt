...
import com.example.barbergo.databinding.ActivityStorageBinding
...
class UsoStorage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var imagesRef: StorageReference? = storageRef.child("cara.jpg")

        // Child references can also take paths
        // spaceRef now points to "images/space.jpg
        // imagesRef still points to "images"
        var spaceRef = storageRef.child("images/cara.jpg") //spock.jpg es el nombre de la imagen
